...
var youtubedl_core_1 = __importDefault(require("youtubedl-core"));
...
var downloadYT = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!youtubedl_core_1.default.validateURL(url))
                ...
                stream = (0, youtubedl_core_1.default)(url, {
...
var downloadYTAndSave = function (url, filename) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, exports.downloadYT)(url)];
                case 1:
                    audio = _a.sent();
                    _a.label = 2;
                case 2:
