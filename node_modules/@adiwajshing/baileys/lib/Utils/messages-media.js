...
const generateProfilePicture = async (mediaUpload, custom) => {
    var _a, _b;
    ...
    if (!custom) {
        ...
        const prom = await Promise.resolve().then(() => Promise.resolve().then(() => __importStar(require('jimp'))));
        const jimp = await prom.read(bufferOrFilePath);
