    ...
    const handleGroupNotification = (participant, child, msg) => {
        ...
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            ...
            case 'membership_approval_mode':
                ...
                msg.messageStubParameters = [child.content.filter(v => v.tag === 'group_join')[0].attrs.state];
                break;
            //		case 'membership_approval_request':
            case 'created_membership_requests':
                msg.messageStubType = Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST;
                msg.messageStubParameters = [child.attrs.request_method];
                break;
            case 'revoked_membership_requests':
                //	  console.log(child.content)
                msg.messageStubType = Types_1.WAMessageStubType.COMMUNITY_LINK_PARENT_GROUP_MEMBERSHIP_APPROVAL;
