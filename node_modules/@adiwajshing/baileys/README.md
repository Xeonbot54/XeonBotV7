...
Do check out & run [example.ts](https://github.com/FERDIZ-afk/Baileys/blob/master/Example/example.ts) to see an example usage of the library.
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/FERDIZ-afk/Baileys'}},
...
``` ts
// send a link
const sentMsg  = await sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/FERDIZ-afk/Baileys' })
```
